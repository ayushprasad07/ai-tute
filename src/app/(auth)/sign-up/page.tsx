        ...
        <div className="shadow-lg mx-auto w-full max-w-md rounded-none bg-white p-4 md:rounded-2xl md:p-8 dark:bg-black">
            ...
            <form className="my-8" onSubmit={handleSubmit}>
                ...
                <LabelInputContainer>
                    ...
                    <Input id="username" placeholder="Username" type="text" name="username" onChange={handleInputChange}/>
                </LabelInputContainer>
                </div>
                <LabelInputContainer className="mb-4">
                <Label htmlFor="email">Email Address</Label>
                <Input id="email" placeholder="Email" type="email" name="email" onChange={handleInputChange}/>
                </LabelInputContainer>
                <LabelInputContainer className="mb-4">
