...
export default function SideBar({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    >
      ...
      {/* Main content */}
      <div className="flex-1 overflow-y-auto bg-gradient-to-br from-neutral-50 via-neutral-50 to-neutral-100 dark:from-neutral-950 dark:via-neutral-900 dark:to-neutral-950">{children}</div>
    </div>
  );
}
